...
#define STRING_CONFIG_H_AUTHOR "(Senhor Rubinho)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Senhor Rubinho [28.03.2024]"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  35.6
    #define DEFAULT_Ki  3.47
    #define DEFAULT_Kd  91.0
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 290.6
  #define DEFAULT_bedKi 56.75
  #define DEFAULT_bedKd 991.8
...
#define LCD_FEEDBACK_FREQUENCY_HZ 4500
